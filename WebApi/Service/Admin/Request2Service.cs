...
{
    public class Request2Service
    {
        private readonly ManagementDbContext _context;
        public Request2Service(ManagementDbContext context)
        {
            _context = context;
        }

        //lấy tất cả yêu cầu của công ty 
        public async Task<PagingResult<Requirement_Company>> GetAllRequest(GetListReqad req, string depart)
        {
           
            if (depart == "HanhChinh") depart = "Hành chính";
            if (depart == "KyThuat") depart = "Kỹ thuật";
